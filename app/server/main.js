...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.ngOnInit = function () {
        return __awaiter(this, void 0, void 0, function () {
            var pipe, title, desc, _a, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        pipe = new mytranslate_pipe_1.MyTranslatePipe(this.platformId);
                        title = pipe.transform(this.data.companyHomeSeo.title);
                        desc = pipe.transform(this.data.companyHomeSeo.description);
                        return [4 /*yield*/, app_component_1.AppComponent.current.setPage('Home', title, desc, environment_1.environment.hostApi + '/media/logo.png')];
                    case 1:
                        _d.sent();
                        _a = this;
